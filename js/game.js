...
(() => {
  ...
  function reset(){
    ...
    banner=null; effects={slowmo:0,magnet:0,double:0,mirror:0}; mirrorOn=false; activeCurses=[]; shields=0; invuln=0; upgradeCounts={}; lives=3; runContinued=false; pendingContinue=false;
