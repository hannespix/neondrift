...
(() => {
  ...
  const RESETS={
    ...
    workshop:()=>{ meta.chips=0; meta.lvl={}; meta.loadout=null; meta.startKit=null; meta.sp=3; meta.spBought=0; saveMeta();
