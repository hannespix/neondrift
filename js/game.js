...
(() => {
  ...
  function reset(){
    ...
    banner=null; effects={slowmo:0,magnet:0,double:0,mirror:0}; mirrorOn=false; activeCurses=[]; shields=0; invuln=0; upgradeCounts={}; lives=3; runContinued=false; pendingContinue=false; jumpCharge=0; jumpStock=mods.jumpMax; jumping=0; jumpClutch=0; jumpClutchFired=false; jumpSeq=0; lastBossName='';
  ...
  // Landungs-Aufprall (Basis): auf Hindernissen/Gegnern landen → großer Schaden, danach 0,5 s Unverwundbarkeit (Gnadenfrist)
