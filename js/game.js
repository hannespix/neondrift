...
(() => {
  ...
  function update(dt){
    ...
    if(mode!=='zen' && jumpCharge>=1 && (elapsed||0)>2.2 && !(meta.seen&&meta.seen.jump)){ meta.seen=meta.seen||{}; meta.seen.jump=1; saveMeta(); banner={text:t('jumpHint'),sub:t('jumpHint2'),t:3.4,color:'#19f0ff'}; }   // einmaliges Tutorial: Tippen = Sprung
